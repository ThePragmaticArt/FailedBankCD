...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [failedBankInfo setName:@"Test Bank"];
    [failedBankInfo setCity:@"Testville"];
    [failedBankInfo setState:@"Testland"];
 
//    NSManagedObject *failedBankInfo = [NSEntityDescription insertNewObjectForEntityForName:@"FailedBankInfo" inManagedObjectContext:context]; //changed to the above because classes were created for failedBankInfo Entity
...
//    [failedBankInfo setValue:@"Testland" forKey:@"state"];
    ...
    [failedBankDetails setCloseDate:[NSDate date]];
    [failedBankDetails setUpdateDate:[NSDate date]];
    [failedBankDetails setZip:[NSNumber numberWithInt:12345]];
    [failedBankDetails setInfo:failedBankInfo];
    [failedBankInfo setDetails:failedBankDetails];
...
//    [failedBankInfo setValue:failedBankDetails forKey:@"details"];
    ...
    for (/*NSManagedObject*/ FailedBankInfo *info in fetchedObjects) {
        NSLog(@"Name: %@", /*[info valueForKey:@"name"]*/ [info name] );
       /* NSManagedObject*/ FailedBankDetails *details = /*[info valueForKey:@"details"]*/ [info details]; //enables us to pull from the relationship table
        NSLog(@"Zip: %@", /*[details valueForKey:@"zip"]*/ [details zip]);
    }
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:[storeURL path]]) {
        ...
        if (![[NSFileManager defaultManager] copyItemAtURL:preloadURL toURL:storeURL error:&err ]) {
            NSLog(@"Could not copy preloaded data: %@", [err localizedDescription]);
        }
    }
