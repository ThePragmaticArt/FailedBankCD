...
- (void)viewDidLoad
{
    ...
    NSError *err;
    self.failedBankInfos = [managedObjectContext executeFetchRequest:fetchRequest error:&err];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[cell detailTextLabel] setText:[NSString stringWithFormat:@"%@, %@", info.city, info.state]];
